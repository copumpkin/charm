...
showConditional (LDM   bang rd regs)   = printf "LDMIA%%s %s%s, %s" (showRegister rd) (cond "" "!" bang) (showArmOpMultiple regs)
...
showConditional (STM   bang rd regs)   = printf "STMIA%%s %s%s, %s" (showRegister rd) (cond "" "!" bang) (showArmOpMultiple regs)
