...
showInstruction (LDRD   rt rt2 mem)   = printf "LDRD%%s %s, %s, %s" (showRegister rt) (showRegister rt2) (showMemOp mem)
...
showInstruction (STRD   rt rt2 mem)   = printf "STRD%%s %s, %s, %s" (showRegister rt) (showRegister rt2) (showMemOp mem)
