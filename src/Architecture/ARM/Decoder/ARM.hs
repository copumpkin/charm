...
armDecoders = 
  ...
  , decoder [ARM_EXT_V1]    0x00500090 0x0e5000f0 (pure Undefined)
  , decoder [ARM_EXT_V1]    0x00500090 0x0e500090 (ldr <$> arm_bh 5 <*> pure False <*> bool 6 <*> reg 12 <*> arm_s) -- "ldr%6's%5?hb%c\t%12-15R, %s"},
  , decoder [ARM_EXT_V1]    0x00100090 0x0e500ff0 (pure Undefined)
  , decoder [ARM_EXT_V1]    0x00100090 0x0e500f90 (ldr <$> arm_bh 5 <*> pure False <*> bool 6 <*> reg 12 <*> arm_s) -- "ldr%6's%5?hb%c\t%12-15R, %s"},
