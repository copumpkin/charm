...
instance Decoder ARM (Instruction UAL Conditional) where
  type Target ARM (Instruction UAL Conditional) = GeneralInstruction UAL

  decoder s v m d = GeneralDecoder s v m (Conditional <$> condition <*> d)

instance Decoder ARM (Instruction UAL Unconditional) where
  type Target ARM (Instruction UAL Unconditional) = GeneralInstruction UAL
...
armDecoders = 
  ...
  , decoder [ARM_EXT_V6T2]  0x00300090 0x0f3000f0 (| Undefined |)
  , decoder [ARM_EXT_V6T2]  0x00300090 0x0f300090 (| ldr (arm_bh 5) ~ True (bool 6) (reg 12) arm_s |)
  ...
  , decoder [ARM_EXT_V6K]   0x0320f003 0x0fffffff (| WFI |)
  , decoder [ARM_EXT_V6K]   0x0320f004 0x0fffffff (| SEV |)
  , decoder [ARM_EXT_V6K]   0x0320f000 0x0fffff00 (| NOP |)
  
  , decoder [ARM_EXT_V6]    0xf1080000 0xfffffe3f (| CPSIE (bool 8) (bool 7) (bool 6) ~ Nothing |)
  , decoder [ARM_EXT_V6]    0xf10a0000 0xfffffe20 (| CPSIE (bool 8) (bool 7) (bool 6) (| Just (integral 0 4) |) |)
  , decoder [ARM_EXT_V6]    0xf10C0000 0xfffffe3f (| CPSID (bool 8) (bool 7) (bool 6) ~ Nothing |)
  ...
  , decoder [ARM_EXT_V6]    0x06200f30 0x0ff00ff0 (  QASX    $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06200f70 0x0ff00ff0 (  QSUB16  $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06200ff0 0x0ff00ff0 (  QSUB8   $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06200f50 0x0ff00ff0 (  QSAX    $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06100f10 0x0ff00ff0 (  SADD16  $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06100f90 0x0ff00ff0 (  SADD8   $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06100f30 0x0ff00ff0 (  SASX    $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06300f10 0x0ff00ff0 (  SHADD16 $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06300f90 0x0ff00ff0 (  SHADD8  $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06300f30 0x0ff00ff0 (  SHASX   $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06300f70 0x0ff00ff0 (  SHSUB16 $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06300ff0 0x0ff00ff0 (  SHSUB8  $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06300f50 0x0ff00ff0 (  SHSAX   $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06100f70 0x0ff00ff0 (  SSUB16  $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06100ff0 0x0ff00ff0 (  SSUB8   $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06100f50 0x0ff00ff0 (  SSAX    $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06500f10 0x0ff00ff0 (  UADD16  $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06500f90 0x0ff00ff0 (  UADD8   $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06500f30 0x0ff00ff0 (  UASX    $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06700f10 0x0ff00ff0 (  UHADD16 $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06700f90 0x0ff00ff0 (  UHADD8  $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06700f30 0x0ff00ff0 (  UHASX   $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06700f70 0x0ff00ff0 (  UHSUB16 $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06700ff0 0x0ff00ff0 (  UHSUB8  $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06700f50 0x0ff00ff0 (  UHSAX   $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06600f10 0x0ff00ff0 (  UQADD16 $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06600f90 0x0ff00ff0 (  UQADD8  $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06600f30 0x0ff00ff0 (  UQASX   $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06600f70 0x0ff00ff0 (  UQSUB16 $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06600ff0 0x0ff00ff0 (  UQSUB8  $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06600f50 0x0ff00ff0 (  UQSAX   $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06500f70 0x0ff00ff0 (  USUB16  $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06500ff0 0x0ff00ff0 (  USUB8   $< reg12_reg16_reg0) 
  , decoder [ARM_EXT_V6]    0x06500f50 0x0ff00ff0 (  USAX    $< reg12_reg16_reg0) 
  ...
  , decoder [ARM_EXT_V6]    0x06800fb0 0x0ff00ff0 (  SEL $< reg12_reg16_reg0 )
  ...
  , decoder [ARM_EXT_V6]    0x01800f90 0x0ff00ff0 (| STREX  (reg 12) (reg 0 ) (| MemReg (reg 16) ~ (Imm 0) ~ False |) |)
  , decoder [ARM_EXT_V6]    0x00400090 0x0ff000f0 (| UMAAL  (reg 12) (reg 16) (reg 0) (reg 8) |)
  , decoder [ARM_EXT_V6]    0x0780f010 0x0ff0f0f0 (  USAD8  $< reg16_reg0_reg8)
  , decoder [ARM_EXT_V6]    0x07800010 0x0ff000f0 (  USADA8 $< reg16_reg0_reg8_reg12)
  ...
  , decoder [ARM_EXT_V5ExP] 0x01000080 0x0ff000f0 (SMLABB  $< reg16_reg0_reg8_reg12)
  , decoder [ARM_EXT_V5ExP] 0x010000a0 0x0ff000f0 (SMLATB  $< reg16_reg0_reg8_reg12)
  , decoder [ARM_EXT_V5ExP] 0x010000c0 0x0ff000f0 (SMLABT  $< reg16_reg0_reg8_reg12)
  , decoder [ARM_EXT_V5ExP] 0x010000e0 0x0ff000f0 (SMLATT  $< reg16_reg0_reg8_reg12)

  , decoder [ARM_EXT_V5ExP] 0x01200080 0x0ff000f0 (SMLAWB  $< reg16_reg0_reg8_reg12)
  , decoder [ARM_EXT_V5ExP] 0x012000c0 0x0ff000f0 (SMLAWT  $< reg16_reg0_reg8_reg12)

  , decoder [ARM_EXT_V5ExP] 0x01400080 0x0ff000f0 (SMLALBB $< reg12_reg16_reg0_reg8)
  , decoder [ARM_EXT_V5ExP] 0x014000a0 0x0ff000f0 (SMLALTB $< reg12_reg16_reg0_reg8)
  , decoder [ARM_EXT_V5ExP] 0x014000c0 0x0ff000f0 (SMLALBT $< reg12_reg16_reg0_reg8)
  , decoder [ARM_EXT_V5ExP] 0x014000e0 0x0ff000f0 (SMLALTT $< reg12_reg16_reg0_reg8)

  , decoder [ARM_EXT_V5ExP] 0x01600080 0x0ff0f0f0 (SMULBB  $< reg16_reg0_reg8)
  , decoder [ARM_EXT_V5ExP] 0x016000a0 0x0ff0f0f0 (SMULTB  $< reg16_reg0_reg8)
  , decoder [ARM_EXT_V5ExP] 0x016000c0 0x0ff0f0f0 (SMULBT  $< reg16_reg0_reg8)
  , decoder [ARM_EXT_V5ExP] 0x016000e0 0x0ff0f0f0 (SMULTT  $< reg16_reg0_reg8)

  , decoder [ARM_EXT_V5ExP] 0x012000a0 0x0ff0f0f0 (SMULWB  $< reg16_reg0_reg8)
  , decoder [ARM_EXT_V5ExP] 0x012000e0 0x0ff0f0f0 (SMULWT  $< reg16_reg0_reg8)

  , decoder [ARM_EXT_V5ExP] 0x01000050 0x0ff00ff0 (QADD    $< reg12_reg0_reg16)
  , decoder [ARM_EXT_V5ExP] 0x01400050 0x0ff00ff0 (QDADD   $< reg12_reg0_reg16)
  , decoder [ARM_EXT_V5ExP] 0x01200050 0x0ff00ff0 (QSUB    $< reg12_reg0_reg16)
  , decoder [ARM_EXT_V5ExP] 0x01600050 0x0ff00ff0 (QDSUB   $< reg12_reg0_reg16)
  ...
  , decoder [ARM_EXT_V1]    0x00500090 0x0e5000f0 (| Undefined |)
  , decoder [ARM_EXT_V1]    0x00500090 0x0e500090 (| ldr (arm_bh 5) ~ False (bool 6) (reg 12) (arm_s) |) -- "ldr%6's%5?hb%c\t%12-15R, %s"},
  , decoder [ARM_EXT_V1]    0x00100090 0x0e500ff0 (| Undefined |)
  , decoder [ARM_EXT_V1]    0x00100090 0x0e500f90 (| ldr (arm_bh 5) ~ False (bool 6) (reg 12) (arm_s) |) -- "ldr%6's%5?hb%c\t%12-15R, %s"},
                            
  , decoder [ARM_EXT_V1]    0x02000000 0x0fe00000 (and $< bool20_reg12_reg16_o)  -- "and%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00000000 0x0fe00010 (and $< bool20_reg12_reg16_o)  -- "and%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00000010 0x0fe00090 (and $< bool20_reg12_reg16_o)  -- "and%20's%c\t%12-15R, %16-19R, %o"},

  , decoder [ARM_EXT_V1]    0x02200000 0x0fe00000 (eor $< bool20_reg12_reg16_o)  -- "eor%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00200000 0x0fe00010 (eor $< bool20_reg12_reg16_o)  -- "eor%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00200010 0x0fe00090 (eor $< bool20_reg12_reg16_o)  -- "eor%20's%c\t%12-15R, %16-19R, %o"},

  , decoder [ARM_EXT_V1]    0x02400000 0x0fe00000 (sub $< bool20_reg12_reg16_o)  -- "sub%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00400000 0x0fe00010 (sub $< bool20_reg12_reg16_o)  -- "sub%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00400010 0x0fe00090 (sub $< bool20_reg12_reg16_o)  -- "sub%20's%c\t%12-15R, %16-19R, %o"},

  , decoder [ARM_EXT_V1]    0x02600000 0x0fe00000 (rsb $< bool20_reg12_reg16_o)  -- "rsb%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00600000 0x0fe00010 (rsb $< bool20_reg12_reg16_o)  -- "rsb%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00600010 0x0fe00090 (rsb $< bool20_reg12_reg16_o)  -- "rsb%20's%c\t%12-15R, %16-19R, %o"},

  , decoder [ARM_EXT_V1]    0x02800000 0x0fe00000 (add $< bool20_reg12_reg16_o)  -- "add%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00800000 0x0fe00010 (add $< bool20_reg12_reg16_o)  -- "add%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00800010 0x0fe00090 (add $< bool20_reg12_reg16_o)  -- "add%20's%c\t%12-15R, %16-19R, %o"},

  , decoder [ARM_EXT_V1]    0x02a00000 0x0fe00000 (adc $< bool20_reg12_reg16_o)  -- "adc%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00a00000 0x0fe00010 (adc $< bool20_reg12_reg16_o)  -- "adc%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00a00010 0x0fe00090 (adc $< bool20_reg12_reg16_o)  -- "adc%20's%c\t%12-15R, %16-19R, %o"},

  , decoder [ARM_EXT_V1]    0x02c00000 0x0fe00000 (sbc $< bool20_reg12_reg16_o)  -- "sbc%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00c00000 0x0fe00010 (sbc $< bool20_reg12_reg16_o)  -- "sbc%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00c00010 0x0fe00090 (sbc $< bool20_reg12_reg16_o)  -- "sbc%20's%c\t%12-15R, %16-19R, %o"},

  , decoder [ARM_EXT_V1]    0x02e00000 0x0fe00000 (rsc $< bool20_reg12_reg16_o)  -- "rsc%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00e00000 0x0fe00010 (rsc $< bool20_reg12_reg16_o)  -- "rsc%20's%c\t%12-15r, %16-19r, %o"},
  , decoder [ARM_EXT_V1]    0x00e00010 0x0fe00090 (rsc $< bool20_reg12_reg16_o)  -- "rsc%20's%c\t%12-15R, %16-19R, %o"},
  ...
  , decoder [ARM_EXT_V1]    0x06000010 0x0e000010 (| Undefined |)


  , decoder [ARM_EXT_V1]    0x049d0004 0x0fff0fff (| POP (| (Regs . pure) (reg 12) |) |) -- "pop%c\t{%12-15r}\t\t; (ldr%c %12-15r, %a)"},
  , decoder [ARM_EXT_V1]    0x04500000 0x0c500000 (| ldr ~ Byte arm_t ~ False (reg 12) arm_a |) -- "ldrb%t%c\t%12-15R, %a"},
  ...
  , decoder [ARM_EXT_V1]    0x04100000 0x0c100000 (| ldr  (arm_bw 22) arm_t ~ False (reg 12) arm_a |)
  ...
  , decoder [ARM_EXT_V1]    0x00000000 0x00000000 (| Undefined |)
  ]
