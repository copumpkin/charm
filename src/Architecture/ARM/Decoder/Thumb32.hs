...
thumb32Decoders =
  ...
  , decoder [ARM_EXT_V6T2] 0xf3af8000 0xffffffff (| NOP |) -- "nop%c.w"},
  , decoder [ARM_EXT_V6T2] 0xf3af8001 0xffffffff (| YIELD |) -- "yield%c.w"},
  , decoder [ARM_EXT_V6T2] 0xf3af8002 0xffffffff (| WFE |) -- "wfe%c.w"},
  , decoder [ARM_EXT_V6T2] 0xf3af8003 0xffffffff (| WFI |) -- "wfi%c.w"},
  , decoder [ARM_EXT_V6T2] 0xf3af8004 0xffffffff (| SEV |) -- "sev%c.w"},
  , decoder [ARM_EXT_V6T2] 0xf3af8000 0xffffff00 (| NOP |) -- "nop%c.w\t{%0-7d}"},

  , decoder [ARM_EXT_V6T2] 0xf3bf8f2f 0xffffffff (| CLREX |) -- "clrex%c"},
  , decoder [ARM_EXT_V6T2] 0xf3af8400 0xffffff1f (| CPSIE    (bool 7) (bool 6) (bool 5) ~ Nothing |) -- "cpsie.w\t%7'a%6'i%5'f%X"},
  , decoder [ARM_EXT_V6T2] 0xf3af8600 0xffffff1f (| CPSID    (bool 7) (bool 6) (bool 5) ~ Nothing |) -- "cpsid.w\t%7'a%6'i%5'f%X"},
  ...
  , decoder [ARM_EXT_V6T2] 0xe8d00f4f 0xfff00fef (| id (choose 4 LDREXH LDREXB) (reg 12) (memReg 16) |) -- "ldrex%4?hb%c\t%12-15r, [%16-19r]"},
  ...
  , decoder [ARM_EXT_V6T2] 0xe8c00f40 0xfff00fe0 (| id (choose 4 STREXH STREXB) (reg 0) (reg 12) (memReg 16) |) -- "strex%4?hb%c\t%0-3r, %12-15r, [%16-19r]"},
  ...
  , decoder [ARM_EXT_V6T2] 0xfb30f000 0xfff0f0e0 (| id (choose 4 SMULWT SMULWB) (reg 8) (reg 16) (reg 0) |) -- "smulw%4?tb%c\t%8-11r, %16-19r, %0-3r"},
  ...
  , decoder [ARM_EXT_V6T2] 0xfb300000 0xfff000e0 (| id (choose 4 SMLAWT SMLAWB) (reg 8) (reg 16) (reg 0) (reg 12) |) -- <*> reg 8 <*> reg 16 <*> reg 0 <*> reg 12) -- "smlaw%4?tb%c\t%8-11R, %16-19R, %0-3R, %12-15R"},
  ...
  , decoder [ARM_EXT_V6T2] 0xf8000e00 0xff900f00 (| str      (width) ~ True (reg 12) address |) -- "str%wt%c\t%12-15r, %a"},
  ...
  , decoder [ARM_EXT_V6T2] 0xf8100e00 0xfe900f00 (| ldr      width ~ True (bool 24) (reg 12) address |) -- "ldr%wt%c\t%12-15r, %a"},
  ...
  , decoder [ARM_EXT_V6T2] 0xf8000000 0xff100000 (| str      width ~ False (reg  12) address |) -- "str%w%c.w\t%12-15r, %a"},
  , decoder [ARM_EXT_V6T2] 0xf8100000 0xfe100000 (| ldr      width ~ False (bool 24) (reg 12) address |) -- "ldr%w%c.w\t%12-15r, %a"},

  , decoder [ARM_EXT_V6T2] 0xf3c08000 0xfbc0d000 (| Undefined |) -- "(pure Undefined) (bcc, cond=0xF)"},
  , decoder [ARM_EXT_V6T2] 0xf3808000 0xfbc0d000 (| Undefined |) -- "(pure Undefined) (bcc, cond=0xE)"},
