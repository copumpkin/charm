...
thumbDecoders = 
  ...
  , decoder [ARM_EXT_V6K]  0xbf00 0xffff (| NOP |)
  , decoder [ARM_EXT_V6K]  0xbf10 0xffff (| YIELD |)
  , decoder [ARM_EXT_V6K]  0xbf20 0xffff (| WFE |)
  , decoder [ARM_EXT_V6K]  0xbf30 0xffff (| WFI |)
  , decoder [ARM_EXT_V6K]  0xbf40 0xffff (| SEV |)
  ...
  , decoder [ARM_EXT_V6]   0xb660 0xfff8 (| CPSIE  (bool 2) (bool 1) (bool 0) ~ Nothing |) -- "cpsie\t%2'a%1'i%0'f%X"},
  , decoder [ARM_EXT_V6]   0xb670 0xfff8 (| CPSID  (bool 2) (bool 1) (bool 0) ~ Nothing |) -- "cpsid\t%2'a%1'i%0'f%X"},
  ...
  , decoder [ARM_EXT_V4T]  0x46C0 0xFFFF (| NOP |) -- "nop%c\t\t\t; (mov r8, r8)"},
  ...
  , decoder [ARM_EXT_V4T]  0x4240 0xFFC0 (| RSBS (reg 0) (reg 3) ~ (Imm 0) |) -- "neg%C\t%0-2r, %3-5r"},
  ...
  , decoder [ARM_EXT_V4T]  0xB000 0xFF80 (| ADD ~ SP ~ SP (| Imm ((`shiftL` 2) . integral 0 6) |) |) -- "add%c\tsp, #%0-6W"},
  , decoder [ARM_EXT_V4T]  0xB080 0xFF80 (| SUB ~ SP ~ SP (| Imm ((`shiftL` 2) . integral 0 6) |) |) -- "sub%c\tsp, #%0-6W"},
  ...
  , decoder [ARM_EXT_V4T]  0x5200 0xFE00 (| STRH (reg 0) (| MemReg (reg 3) (| Reg (reg 6) |) ~ False |) |) -- "strh%c\t%0-2r, [%3-5r, %6-8r]"},
  , decoder [ARM_EXT_V4T]  0x5A00 0xFE00 (| LDRH (reg 0) (| MemReg (reg 3) (| Reg (reg 6) |) ~ False |) |) -- "ldrh%c\t%0-2r, [%3-5r, %6-8r]"},
  , decoder [ARM_EXT_V4T]  0x5600 0xF600 (| ldr  (choose 11 Byte Halfword) ~ False ~ True (reg 0) (| MemReg (reg 3) (| Reg (reg 6) |) ~ False |) |) -- "ldrs%11?hb%c\t%0-2r, [%3-5r, %6-8r]"},
  
  , decoder [ARM_EXT_V4T]  0x5000 0xFA00 (| str  (choose 10 Word Byte) ~ False (reg 0) (| MemReg (reg 3) (| Reg (reg 6) |) ~ False |) |) -- "str%10'b%c\t%0-2r, [%3-5r, %6-8r]"},
  , decoder [ARM_EXT_V4T]  0x5800 0xFA00 (| ldr  (choose 10 Word Byte) ~ False  ~ False (reg 0) (| MemReg (reg 3) (| Reg (reg 6) |) ~ False |) |) -- "ldr%10'b%c\t%0-2r, [%3-5r, %6-8r]"},
  ...
  , decoder [ARM_EXT_V4T]  0x4800 0xF800 (| LDR  (reg 8) (| MemReg ~ PC (| Imm ((`shiftL` 2) . integral 0 7) |) ~ False |) |) -- "ldr%c\t%8-10r, [pc, #%0-7W]\t; (%0-7a)"},  /* TODO: Disassemble PC relative "LDR rD,=<symbolic>" */

  , decoder [ARM_EXT_V4T]  0x6000 0xF800 (| STR  (reg 0) (| MemReg (reg 3) (| Imm ((`shiftL` 2) . integral 6 10) |) ~ False |) |) -- "str%c\t%0-2r, [%3-5r, #%6-10W]"},
  , decoder [ARM_EXT_V4T]  0x6800 0xF800 (| LDR  (reg 0) (| MemReg (reg 3) (| Imm ((`shiftL` 2) . integral 6 10) |) ~ False |) |) -- "ldr%c\t%0-2r, [%3-5r, #%6-10W]"},
  , decoder [ARM_EXT_V4T]  0x7000 0xF800 (| STRB (reg 0) (| MemReg (reg 3) (| Imm (integral 6 10) |) ~ False |) |) -- "strb%c\t%0-2r, [%3-5r, #%6-10d]"},
  , decoder [ARM_EXT_V4T]  0x7800 0xF800 (| LDRB (reg 0) (| MemReg (reg 3) (| Imm (integral 6 10) |) ~ False |) |) -- "ldrb%c\t%0-2r, [%3-5r, #%6-10d]"},

  , decoder [ARM_EXT_V4T]  0x8000 0xF800 (| STRH (reg 0) (| MemReg (reg 3) (| Imm ((`shiftL` 1) . integral 6 10) |) ~ False |) |) -- "strh%c\t%0-2r, [%3-5r, #%6-10H]"},
  , decoder [ARM_EXT_V4T]  0x8800 0xF800 (| LDRH (reg 0) (| MemReg (reg 3) (| Imm ((`shiftL` 1) . integral 6 10) |) ~ False |) |) -- "ldrh%c\t%0-2r, [%3-5r, #%6-10H]"},

  , decoder [ARM_EXT_V4T]  0x9000 0xF800 (| STR  (reg 8) (| MemReg ~ SP (| Imm ((`shiftL` 2) . integral 0 7) |) ~ False |) |) -- "str%c\t%8-10r, [sp, #%0-7W]"},
  , decoder [ARM_EXT_V4T]  0x9800 0xF800 (| LDR  (reg 8) (| MemReg ~ SP (| Imm ((`shiftL` 2) . integral 0 7) |) ~ False |) |) -- "ldr%c\t%8-10r, [sp, #%0-7W]"},

  , decoder [ARM_EXT_V4T]  0xA000 0xF800 (| ADD  (reg 8) ~ PC (| Imm ((`shiftL` 2) . integral 0 7) |) |) -- "add%c\t%8-10r, pc, #%0-7W\t; (adr %8-10r, %0-7a)"},
  , decoder [ARM_EXT_V4T]  0xA800 0xF800 (| ADD  (reg 8) ~ SP (| Imm ((`shiftL` 2) . integral 0 7) |) |) -- "add%c\t%8-10r, sp, #%0-7W"},
  ...
  , decoder [ARM_EXT_V4T]  0xDE00 0xFE00 (| Undefined |)
  ...
  , decoder [ARM_EXT_V1]   0x0000 0x0000 (| Undefined |)
